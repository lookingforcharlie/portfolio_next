...
const Project: FC<ProjectProps> = (project) => {
  ...
  return (
    ...
    >
      <section className='relative  bg-gray-200 rounded-md max-w-[30rem] sm:max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 sm:h-[22rem] group-odd:pl-10 hover:bg-gray-300 hover:shadow-lg transition'>
          ...
          <div className='flex items-center justify-start gap-6 mt-8 text-xl font-semibold'>
            {demo === '#' ? null : (
              <Link
                ...
                className='mt-2 text-blue-900 relative overflow-hidden py-1 after:h-[2px] after:w-full after:bottom-0 after:right-full after:bg-orange-700 after:absolute hover:after:right-0 after:duration-200 '
              >
                Demo
              </Link>
            )}
